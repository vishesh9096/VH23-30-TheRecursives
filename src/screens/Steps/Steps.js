            ...
            <TouchableOpacity>
                <View style={{flexDirection:"row", marginBottom:Utils.ScreenHeight(1)}}>
                    ...
                    <View style={{flex:1, justifyContent:"space-evenly"}}>
                        ...
                        <Text style={{fontSize:23, fontWeight:400}}>Steps covered: {item.value} </Text>
  ...
  return (
    <SafeAreaView style={{backgroundColor:colors.white, flex:1}}>
         ...
         marginHorizontal: Utils.ScreenWidth(4), alignItems: "center",backgroundColor:colors.white,  }}>
                    ...
                    <Text style={{ flex: 1, textAlign: "center", marginRight: Utils.ScreenWidth(5), fontSize: 20, fontWeight: "600" }}>Steps Tracking</Text>
                </View>
